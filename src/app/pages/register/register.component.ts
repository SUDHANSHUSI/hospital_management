...
export class RegisterComponent {
  ...
  registrationForm = new FormGroup({
    ...
    phoneNum: new FormControl('', [Validators.required,Validators.maxLength(10),Validators.pattern(/^[0-9]*$/)]),
  ...
  },[matchPasswordValidator("password","confirmPassword"),phoneValidator("phoneNum")]);
